...
export default function About() {
  ...
  return (
    <section id="about" ref={sectionRef} className="relative z-10 min-h-screen px-4 py-20 sm:px-6 sm:py-28 md:px-14 md:py-32">
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 md:grid-cols-[1fr_1.4fr] md:gap-16">
        {/* Profile Image */}
        <div className="scroll-animate flex items-center justify-center" data-animate>
          <div className="group relative">
            ...
            <div className="relative h-[200px] w-[200px] overflow-hidden rounded-full border-2 border-accent/10 p-[3px] sm:h-[260px] sm:w-[260px] md:h-[280px] md:w-[280px]">
        ...
        <div>
          <div className="scroll-animate" data-animate>
            ...
            <h2 className="section-title mb-4 sm:mb-5 text-2xl sm:text-3xl md:text-5xl">
          ...
          <div className="scroll-animate stagger-2" data-animate>
            <p className="mb-3 sm:mb-4 text-[13px] leading-6 text-apptext/40 sm:text-base sm:leading-8">
            ...
            <p className="text-[13px] leading-6 text-apptext/40 sm:text-base sm:leading-8">
          ...
          {/* Stats */}
          <div className="mt-6 sm:mt-8 grid grid-cols-2 gap-2.5 sm:grid-cols-4 sm:gap-4">
            {stats.map((s, i) => (
              <div
                key={s.label}
                className={`scroll-animate stagger-${i + 3} glass-card-hover p-3 sm:p-4 text-center group`}
                data-animate
              >
                <div className="font-display text-xl sm:text-2xl font-bold tracking-tight" style={{ color: s.color }}>{s.value}</div>
                <div className="mt-0.5 sm:mt-1 text-[10px] sm:text-[11px] uppercase tracking-[0.12em] sm:tracking-[0.15em] text-apptext/30">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
