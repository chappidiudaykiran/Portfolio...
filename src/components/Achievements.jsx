      ...
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {ACHIEVEMENTS.map((a, i) => (
            <div
              key={a.title}
              className="scroll-animate group glass-card-hover neon-border flex items-start gap-4 p-5 sm:p-6"
              data-animate
            ...
            >
              ...
              <div>
                ...
                <p className="text-[13px] leading-6 text-apptext/35 sm:text-sm">
                  {a.sub}
                </p>
              </div>
            </div>
